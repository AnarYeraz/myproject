...
namespace EmailMicroservice.Services
{
    public class RabbitConsumerService : BackgroundService
    {
        ...
        public RabbitConsumerService(IOptions<RabbitConfiguration> config, IDiscordService service, IRabbitProducer producer)
        {
            ...
            channel.QueueDeclare(queue: "ds",
                                  durable: true,
                                  exclusive: false,
                                  autoDelete: false,
                                  arguments: null);

            channel.QueueBind(queue: "ds", exchange: configuration.Exchange, routingKey: "ds");
        }
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            channel.BasicConsume(queue: "ds", autoAck: false, consumer: consumer);
